...
#ifndef FIMC_IS_DEVICE_SR352_REG_H
#define FIMC_IS_DEVICE_SR352_REG_H

static struct sensor_reg sr352_Init_Reg[] =
{
	///////////////////////////////////////////////////////////////////////////////
...
static struct sensor_reg sr352_Init_VT_Reg[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_176_144[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg sr352_resol_320_240[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg sr352_resol_352_288[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg sr352_resol_640_480[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg sr352_resol_800_600[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg sr352_resol_704_576[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
///////////////////////////////////////////
	...
	{0x30, 0x05},  // l_pkt_wc_h  // Pre = 704 * 2 (YUV)
	{0x31, 0x80},  // l_pkt_wc_l
//------------------------------------//
...
static struct sensor_reg sr352_resol_1280_720[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
//------------------------------------------------//
	...
	{0x99, 0x10},
	{0x9a, 0xA6},
	{0x9b, 0x80},		// exp_band_100 * 2
	{0x9c, 0x00},
	{0x9d, 0x0d},
	{0x9e, 0xd4},
	{0x9f, 0xa0},		// exp_band_120 * 2
...
static struct sensor_reg sr352_resol_1280_960[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_1600_1200[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_1024_576[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01},
...
//------------------------------------//
	...
	{0xff, 0x01}, //delay 10ms
	/* END of sr352_preview. */
};

static struct sensor_reg sr352_resol_1024_768[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01},
...
static struct sensor_reg sr352_resol_640_480_capture[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
static struct sensor_reg sr352_resol_1280_720_capture[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
static struct sensor_reg sr352_resol_1600_1200_capture[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
///////////////////////////////////////////
	{0x03, 0x05},  // Page05
	{0x30, 0x0c},  // l_pkt_wc_h  // Full = 1600 * 2 (YUV)
	{0x31, 0x80},  // l_pkt_wc_l
...
static struct sensor_reg sr352_resol_2048_1152_capture[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
///////////////////////////////////////////
	{0x03, 0x05},  // Page05
	{0x30, 0x10},  // l_pkt_wc_h  // Full = 2048 * 2 (YUV)
	{0x31, 0x00},  // l_pkt_wc_l
...
static struct sensor_reg sr352_resol_2048_1536_capture[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
static struct sensor_reg  sr352_start_stream[] = {
	{0x03, 0x00},
	{0x1e, 0x01},
	{0x01, 0x00},
	{0xff, 0x01},
...
static struct sensor_reg  sr352_i2c_check[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_Effect_Normal[] = {
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x10},
	{0x42, 0x00},
...
static struct sensor_reg  sr352_Effect_Aqua[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_fps_auto[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01},
...
static struct sensor_reg  sr352_fps_15_camcorder[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_fps_7_camcorder[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_fps_25_camcorder[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_fps_30_camcorder[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sensor_reg  sr352_anti_banding_flicker_50hz[] = {
	{0x03, 0x00},
	{0x01, 0x00},
	{0xff, 0x02},

	{0x03, 0x20},
	{0x10, 0xbd}, //50hz , 0xbd}, 60hz ad
	{0x20, 0x00}, //Start ExpTime 120fps
	{0x21, 0x06},
	{0x22, 0xea},
	{0x23, 0x50},
...
//Shutter Setting
	{0x03, 0xc7},
	{0x10, 0x70},	//AE Off (Band Off) 50hz , 0x70}, 60hz 50
	{0x12, 0x30}, // Fast speed
	{0x15, 0xc0}, // SSD Patch Weight Y Mean On
	...
	{0x03, 0xc7},
	{0x10, 0xf0},	//AE On 50hz , 0xf0}, 60hz d0
};

static struct sensor_reg  sr352_anti_banding_flicker_60hz[] = {
	{0x03, 0x00},
	{0x01, 0x00},
	{0xff, 0x02},

	{0x03, 0x20},
	{0x10, 0xad}, //50hz , 0xbd}, 60hz ad
	{0x20, 0x00}, //Start ExpTime 120fps
	{0x21, 0x06},
	{0x22, 0xea},
	{0x23, 0x50},
...
//Shutter Setting
	{0x03, 0xc7},
	{0x10, 0x50},	//AE Off (Band Off) 50hz , 0x70}, 60hz 50
	{0x12, 0x30}, // Fast speed
	{0x15, 0xc0}, // SSD Patch Weight Y Mean On
	...
	{0x03, 0xc7},
	{0x10, 0xd0},	//AE On 50hz , 0xf0}, 60hz d0
};

static struct sensor_reg  sr352_video_mode_preview[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_video_mode_encode[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_video_mode_upcc[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_work_mode_auto[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_night_normal[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_night_dark[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg  sr352_AE_on_50Hz[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_AE_off_50Hz[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_AE_on_60Hz[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_AE_off_60Hz[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg  sr352_contrast_m4[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_m3[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_m2[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_m1[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_default[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_p1[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_p2[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_p3[] = {
	{0xff, 0xff},
};

static struct sensor_reg  sr352_contrast_p4[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg sr352_wb_daylight[] = {
	{0x03, 0xc8},
	{0x10, 0x52}, //AWB Off
...
static struct sensor_reg sr352_flip_off[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_hflip[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_vflip[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_camcorder_flip[] = {
	{0xff, 0xff},
};
