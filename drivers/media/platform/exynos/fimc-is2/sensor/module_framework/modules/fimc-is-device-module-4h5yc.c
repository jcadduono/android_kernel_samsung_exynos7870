...
static struct fimc_is_sensor_cfg config_module_4h5yc[] = {
	...
	/* 3280x1846@30fps */
	FIMC_IS_SENSOR_CFG(3280, 1846, 30, 14, 1, CSI_DATA_LANES_4),
	/* 1640x924_60fps */
	FIMC_IS_SENSOR_CFG(1640, 924, 60, 14, 2, CSI_DATA_LANES_4),
	/* 816x604_115fps */
	FIMC_IS_SENSOR_CFG(816, 604, 115, 14, 3, CSI_DATA_LANES_4),
	/* 816x460_120fps */
	FIMC_IS_SENSOR_CFG(816, 460, 120, 14, 4, CSI_DATA_LANES_4),
};
